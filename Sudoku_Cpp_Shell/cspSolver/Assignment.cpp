...
Assignment::Assignment(Variable* v, int val){ //: variable(v){value = val;}
	variable = v;
	value = val;
}

Assignment::Assignment(Variable* v, int val, int score){// : variable(v){value = val, score = score;}
	variable = v;
	value = val;
}
